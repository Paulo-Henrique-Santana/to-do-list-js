...
const criarTarefa = (textoTarefa, feita = false, cor) => {
  if (textoTarefa !== '') {
    ...
    addEventosTarefa(tarefa);
    adicionarTarefa(tarefa);
  }
}

const addEventosTarefa = (tarefa) => {
  ...
  tarefa.querySelectorAll('.paleta-cores button').forEach((botao) => {
...
const carregarTarefas = () => {
  ...
  arrayTarefas.forEach(tarefa => criarTarefa(tarefa.texto, tarefa.feita, tarefa.cor));
}
